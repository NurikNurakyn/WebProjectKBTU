...
export const MOUNTAIN_WIKI: MountainWiki[] = [
  ...
  },
  {
    ...
    minimumRankId: 2,
    summary: 'Higher altitude route with stronger exposure. Best after several confirmed climbs.',
  ...
  },
  {
    ...
    minimumRankId: 3,
    summary: 'Tall objective requiring stronger acclimatization and route discipline.',
  ...
  },
  {
    ...
    requiredGear: [
      'Expedition-grade shelter',
      'Technical ice kit',
      'Satellite backup',
      'Extended food/fuel reserve',
    ],
    cardImage: {
